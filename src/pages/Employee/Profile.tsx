    ...
    <div className="profile-card ">
      <div className="profile-info">
        ...
        <div className="grid-container">
          ...
          <div>
            <strong>Contact:</strong> {employeeData.contact_no}
          </div>
          <div>
          ...
          <div>
            <strong>Date of Joining:</strong> {employeeData.date_of_joining}
          </div>
          <div>
            <strong>Office Location:</strong> {employeeData.location}
          </div>
        </div>
      </div>
